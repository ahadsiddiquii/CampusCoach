...
public class ViewHolderDriver  extends RecyclerView.ViewHolder {
    ...
    private com.userapi.myapplication.ViewHolderDriver.ClickListener mClickListener;
    ...
    public void setOnClickListener(com.userapi.myapplication.ViewHolderDriver.ClickListener clickListener){
