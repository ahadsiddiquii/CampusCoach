...
public class ViewHolderStudents  extends RecyclerView.ViewHolder {
    ...
    private com.userapi.myapplication.ViewHolderStudents.ClickListener mClickListener;
    ...
    public void setOnClickListener(com.userapi.myapplication.ViewHolderStudents.ClickListener clickListener){
