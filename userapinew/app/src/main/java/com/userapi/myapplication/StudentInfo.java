...
public class StudentInfo {
    ...
    public StudentInfo(String studentName, String studentID,String gaurdianCNIC,String email, String pointnumber,String contact,String joindate,String account,String password){
