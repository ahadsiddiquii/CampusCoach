...
public class ViewHolderDriver  extends RecyclerView.ViewHolder {
    ...
    private com.example.adminapi.ViewHolderDriver.ClickListener mClickListener;
    ...
    public void setOnClickListener(com.example.adminapi.ViewHolderDriver.ClickListener clickListener){
