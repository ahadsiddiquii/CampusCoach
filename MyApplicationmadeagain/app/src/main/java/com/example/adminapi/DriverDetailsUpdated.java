...
//                        final long Announceno=getItem(position).getAno();
                    ...
                    AlertDialog.Builder builder=new AlertDialog.Builder(DriverDetailsUpdated.this);
                    ...
                    builder.setItems(options, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(which==0){
                                Intent intent =new Intent(DriverDetailsUpdated.this,AddDriver.class);
                                intent.putExtra("dname",Dname);
                                intent.putExtra("dcnic",Dcnic);
                                intent.putExtra("dpointno",Dpointno);
                                intent.putExtra("djoindate",Djoineddate);
                                intent.putExtra("demail",Demail);
                                intent.putExtra("dcontact",Dcontact);
                                startActivity(intent);
                            }
                            else if(which==1){
                                showDeleteDataDialog(Dcnic);
                            }
                        }
                    });
                    builder.create().show();
...
//
    ...
    private void showDeleteDataDialog(final String drivercnic) {
        AlertDialog.Builder builder=new AlertDialog.Builder(DriverDetailsUpdated.this);
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Query mQuery=mRef.orderByChild("dcnic").equalTo(drivercnic);
                mQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(DriverDetailsUpdated.this, "Driver removed successfully", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {

                        Toast.makeText(DriverDetailsUpdated.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_add){
            startActivity(new Intent(DriverDetailsUpdated.this,AddDriver.class));
            return true;
        }
    ...
    private void firebaseSearch(String searchText) {
        ...
        Query firebaseSearchQuery = mRef.orderByChild("dpointno").startAt(searchText).endAt(searchText + "\uf8ff");
